window.addEventListener('load',function(){
    ...
    canvas.height = 500; 
        ...
        // Create the 'Start Over' button and attach a click event listener to it
    ...
    class Particle {
        ...
        update(){
            ...
            this.y += this.speedY;
            if (this.y > this.game.height + this.size || this.x < 0 - this.size) this.
        ...
        draw(context){
            ...
            * this.spriteSize, this.spriteSize, this.spriteSize,this.size * -0.5, this. 
              size * -0.5, this.size, this.size);
              context.restore();
        }
    }
    class Player {
    ...
    class UI {
         ...
         draw(context){
            ...
            // ammo 
            if (this.game.player.powerUp) context.fillStyle = '#f0d911';
    ...
    class Game {
        ...
        update(deltaTime){
            ...
            this.explosions = this.explosions.filter(explosion => !explosion.
                markedForDeletion);
                ...
                this.player.projectiles.forEach(projectile => {
                    if (this.checkCollision(projectile, enemy)){
                        ...
                        if (enemy.lives <= 0){
                            ...
                            if (enemy.type === 'hive'){
                                for (let i = 0; i < 5; i++) {
                                    this.enemies.push(new Drone(this, enemy.x + 
                                    Math.random() * enemy.width, enemy.y + 
                                    Math.random() * enemy.height * 0.5 ));
                                }
                            }
